...
export default function ListaPecas(){
    ...
    const [cidade, setCidade] = useState(["arroz","feijao","commida","lazanha","pimenta",'galinha'])
        ...
        <>
            <h1 className={styles.h1}>Olha o que encontramos!</h1>
                ...
                <div className={styles.container}>
                    ...
                    {cidade.map((item, index) => (<li className={styles.liList} key={index}>
                        <button className={styles.buttonId} onClick={() => Router.push(`/item-${item}`)}>
